...
## 2.Run the following program and click the left, middle, right buttons to calls a specific function.
import  tkinter

root= tkinter.Tk()
root.title("Click Functions")
# Creating 3 different functions for 3 events
def left_click(event):
    tkinter.Label(root, text="Left Click").pack()
def middle_click(event):
    tkinter.Label(root, text="Middle Click").pack()
...
# 3. activebackground properties will change the button background color while clicking the button.
# from tkinter import *
# master = Tk()
#
